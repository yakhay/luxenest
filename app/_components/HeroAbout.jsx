    ...
    <div>
        ...
        <div className="absolute inset-0 bg-black opacity-40"></div>
            ...
            <div className='w-[80%] flex justify-center items-center flex-col '>
                    ...
                    <h1 className='text-[100px] text-white z-50'>About</h1>
                    <nav  className="flex justify-center">
                        <ol className="flex overflow-hidden rounded-lg   text-white">
                            ...
                            <li className="relative flex items-center">                    
                                <Link href="/About" className="flex h-10 items-center  pe-4 ps-8 text-xs font-medium transition hover:text-gray-900" >
                                <GiLevelFour className='size-5 pr-[3px]' /> About
                                </Link>
                            </li>
                        </ol>
                    </nav>
